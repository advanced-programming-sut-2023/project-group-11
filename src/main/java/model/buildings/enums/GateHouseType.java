...
public enum GateHouseType {
    ...
    SMALL_HORIZONTAL("small gatehouse",2,114,10,AllResource.STONE,0,0,
            true,false,0,8,true),
    LARGE_HORIZONTAL("large gatehouse",3,150,0, AllResource.STONE,20,0,
            true,false,0,10,true),
    SMALL_VERTICAL("small gatehouse",2,114,10,AllResource.STONE,0,0,
                             true,false,0,8,false),
    LARGE_VERTICAL("large gatehouse",3,150,0,AllResource.STONE,20,0,
