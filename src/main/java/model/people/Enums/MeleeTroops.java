...
public enum MeleeTroops {
    ...
    PIKEMAN(Hp.HIGH, Speed.LOW, Utils.PIKE, Utils.METAL_ARMOR, Damage.MEDIUM, false, false, false, false, true, 8),
    MACEMAN(Hp.MEDIUM, Speed.MEDIUM, Utils.MACE, Utils.LEATHER_ARMOR, Damage.HIGH, false, false, false, true, true, 8),
    SWORDSMAN(Hp.HIGH, Speed.VERY_LOW, Utils.SWORD, Utils.METAL_ARMOR, Damage.VERY_HIGH, false, false, false, false, false, 8),
    KNIGHT(Hp.HIGH, Speed.VERY_HIGH, Utils.SWORD, Utils.METAL_ARMOR, Damage.VERY_HIGH, true, false, false, false, false, 8),
