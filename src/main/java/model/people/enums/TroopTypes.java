...
public enum TroopTypes {
    ...
    CROSSBOWMAN         (Hp.MEDIUM,     Speed.LOW,          TroopEquipment.CROSSBOW,    null,                Damage.LOW,       false, false, false, 3, 1, false, false, true, 12),
    SPEARMAN            (Hp.VERY_LOW,   Speed.MEDIUM,       TroopEquipment.SPEAR,       null,                Damage.MEDIUM,    false, false, false, 1, 1, true, true, true, 8),
    PIKEMAN             (Hp.HIGH,       Speed.LOW,          TroopEquipment.PIKE,         TroopEquipment.METAL_ARMOR,   Damage.MEDIUM,     false, false, false, 1, 1, false, true, true, 8),
    MACEMAN             (Hp.MEDIUM,     Speed.HIGH,         TroopEquipment.MACE,         TroopEquipment.LEATHER_ARMOR, Damage.HIGH,      false, false, false, 1, 1, true, true, true, 8),
    SWORDSMAN           (Hp.HIGH,       Speed.VERY_LOW,     TroopEquipment.SWORD,        TroopEquipment.METAL_ARMOR,   Damage.VERY_HIGH,  false, false, false, 1, 1, false, false, true, 8),
    KNIGHT              (Hp.HIGH,       Speed.VERY_HIGH,    TroopEquipment.SWORD,        TroopEquipment.METAL_ARMOR,   Damage.VERY_HIGH, true, false, false, 1, 1, false, false, true, 8),
    TUNNELER            (Hp.VERY_LOW,   Speed.HIGH,         null,            null,                Damage.MEDIUM,    false, false, false, 1, 1, false, false, true, 8),
    LADDERMAN           (Hp.VERY_LOW,   Speed.HIGH,         null,            null,                Damage.NO_ATTACK,  false, false, false, 0, 0, false, false, true, 8),
    BLACK_M0NK          (Hp.MEDIUM,     Speed.LOW,          null,            null,                Damage.MEDIUM,     false, false, false, 1, 1, false, false, true, 8),
    ARCHER_BOW          (Hp.LOW,        Speed.HIGH,         null,            null,                Damage.LOW,        false, true, false, 5, 0.5, false, true, true, 12),
    SLAVES              (Hp.VERY_LOW,   Speed.HIGH,         null,            null,                Damage.VERY_LOW,   false, true, true, 1,  1, false, true, true, 8),
    ...
    HORSE_ARCHER        (Hp.MEDIUM,     Speed.VERY_HIGH,    null,            null,                Damage.LOW,        true, true, false, 5, 0.5, false, false, true, 12),
    ARABIAN_SWORDSMAN   (Hp.HIGH,       Speed.LOW,          null,            null,                Damage.HIGH,        false, true, false, 1, 1, false, false, true, 8),
    FIRE_THROWER        (Hp.LOW,        Speed.MEDIUM,       null,            null,                Damage.HIGH,       false, true, true, 3, 1, false, false, true, 12),
    ;
    private final Hp hp;
