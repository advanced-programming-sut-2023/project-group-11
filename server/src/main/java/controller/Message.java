...
public enum Message {
    ...
    ALREADY_REQUESTED,
    ALREADY_FRIEND,
    YOU_REACHED_FRIEND_LIMIT,
    HE_REACHED_FRIEND_LIMIT,
    SELF_FRIENDSHIP,
    //SELECT_BUILDING
    NO_MORE_ACTION,
    INVALID_TYPE,
    ...
    NOT_ENOUGH_AMOUNT, USER_ALREADY_LOGGED_IN, USER_HAS_MAP, GAME_FULL, YOURE_IN_GAME, YOURE_NOT_IN, ITS_JUST_YOU,
}
